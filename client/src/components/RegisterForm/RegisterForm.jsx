...
return (
	...
	<h1 className="RegisterTitle">Register</h1>
		<input id="name" className="name" type="text" placeholder="Full Name (min 7 characters)" {...register("name", {required:true, minLength:1, maxLength:35})} />

		<input id="tel" type="tel" className="tel" placeholder="Phone Number (min 10 characters)" {...register("phoneNumber", {required: true, minLength:6, maxLength:14 })} />
		{/* , pattern:regexConst {errors.phoneNumber?.type != "pattern" && <span className="num">Phone number in E.164 format: +123456789</span>} */}

		<input id="password" className="password" type="password" placeholder="Password (min 10 characters)" {...register("password", {required:true, minLength:6, maxLength:35})} />
